...
CREATE TABLE "couple_members" (
	...
	CONSTRAINT "couple_members_user_id_unique" UNIQUE("user_id")
);
--> statement-breakpoint
...
ALTER TABLE "couple_invites" ADD CONSTRAINT "couple_invites_couple_id_couples_id_fk" FOREIGN KEY ("couple_id") REFERENCES "public"."couples"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "couple_invites" ADD CONSTRAINT "couple_invites_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "couple_invites_couple_id_idx" ON "couple_invites" USING btree ("couple_id");